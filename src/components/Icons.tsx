...
export function ArrowUpRightIcon({ className = "w-5 h-5", size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function BoltIcon({ className = "w-5 h-5", size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function DiamondBulletIcon({ className = "w-3 h-4", size = 14 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
      ...
      aria-hidden="true"
    >
      <path d="M7 1L13 8L7 15L1 8Z" />
    </svg>
  );
}

export function ArrowLeftIcon({ className = "w-4 h-4", size = 16 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function LinkedinIcon({ className = "w-5 h-5", size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
...
export function TwitterIcon({ className = "w-5 h-5", size = 20 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
